    ...
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6 bg-gradient-to-br from-purple-50 to-white min-h-screen">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-purple-900">Create New Church</h2>
            <p className="text-purple-600">Add detailed information about your church</p>
          </div>
        </div>
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm text-purple-600">
                  Use this to automatically fill coordinates based on your current location
                </p>
              </div>
              {latitude && longitude && (
